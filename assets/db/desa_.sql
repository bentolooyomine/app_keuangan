...
(3, 'Profil Desa', 'bi bi-bank', 3, 1, '2026-05-03 00:59:01'),
(4, 'Kependudukan', 'bi bi-card-text', 4, 1, '2026-05-03 00:59:01'),
(5, 'Informasi', 'bi bi-newspaper', 5, 1, '2026-05-03 00:59:01'),
(6, 'Sekretariat', 'bi bi-folder', 6, 1, '2026-05-03 00:59:01'),
(7, 'Administrasi Desa', 'bi bi-file-earmark', 7, 1, '2026-05-03 00:59:01'),
(8, 'Keuangan', 'bi bi-cash-stack', 8, 1, '2026-05-03 00:59:01'),
(9, 'Layanan Surat', 'bi bi-envelope', 9, 1, '2026-05-03 00:59:01'),
(10, 'Layanan Mandiri', 'bi bi-phone', 10, 1, '2026-05-03 00:59:01'),
(11, 'Pemetaan', 'bi bi-map', 11, 1, '2026-05-03 00:59:01'),
(12, 'Pengaturan', 'bi bi-gear', 12, 1, '2026-05-03 00:59:01');
...
INSERT INTO `settings` (`id`, `nama_desa`, `kecamatan`, `kabupaten`, `provinsi`, `alamat`, `kode_pos`, `telepon`, `email`, `website`, `nama_kepala_desa`, `nip_kepala_desa`, `logo`, `created_at`, `updated_at`) VALUES
(1, 'Desa Kalangan', 'Kecamatan Klego', 'Kabupaten Boyolali', 'Jawa Tengah', 'Jl. Raya Desa No. 1', NULL, NULL, NULL, NULL, 'Nama Kepala Desa', NULL, NULL, '2026-05-03 01:07:52', '2026-05-03 01:08:40');
...
(4, 3, 'Profil Desa', 'profil', 'fas fa-landmark', 1),
(5, 12, 'Setting Website', 'setting', 'fas fa-cogs', 1);
...
(1, 'Administrator', 'admin', NULL, '$2y$10$iDRPyMj22lsf0YcYrTLhH.CR3gZqvr.PncMbyW6YDXDtu19Mq71pC', NULL, NULL, 1, 1, '2026-05-06 09:18:21', '2026-05-03 01:03:56', '2026-05-06 07:18:21', NULL);
